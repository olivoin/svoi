...
<section class="front-about">
    <div class="wrap hor-wrap dis-flex flex-wrap-wrap justify-content-between">
        <div class="front-about-left col-4-6 dis-flex flex-wrap-wrap justify-content-between align-items-center">
            ...
            <div class="col-4-6 text-block padding-l-40">
                <h2 class="front-about-title">Бар «Свои»</h2>
                <p class="front-about-desc">― самый крупный бар крафтового пива
в Сергиев Посаде с уютной атмосферой
и тематическим интерьером.</p>
            </div>
        </div>
        <div class="front-about-right col-1-6 text-block">
            <ul> 
                <li class="dis-flex">
